...
namespace RockPaperScissors
{
    class Program
    {
        static Dictionary<string, IPlayer> AIPlayers = new Dictionary<string, IPlayer>()
        {
            ...
            { "Random AI", new RandomAI() },
            { "Stubborn AI" , new StubAI() },
            { "Short Attention AI", new ShortAttentionAI() },
        ...
        static int RunGame(IPlayer player1, IPlayer player2)
        {
            ...
            Console.WriteLine("Player 1 Last Move: {0}\t Player 2 Last Move: {1}", MoveToString(p1Choice), MoveToString(p2Choice));
